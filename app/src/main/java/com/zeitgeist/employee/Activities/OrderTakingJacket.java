...
public class OrderTakingJacket extends AppCompatActivity {

    String orderCondition;

    IpClass ipClass = new IpClass();

    String shopId,itemType,orderId,fabricConnsumption,liningConsumption,garmentId = "3";
    TextView title;
    ...
    EditText rightSleeve,leftSleeve,bicep,wrist,waistStomach,hip,frontJacketLength,frontChestWidth,
            backWidth,halfShoulderWidthLeft,halfShoulderWidthRight,fullBackLength,halfBackLength,rightFullSleeve,leftFullSleeve;
    ImageView rightSleeveImage,leftSleeveImage,bicepImage,wristImage,waistStomachImage,hipImage,frontJacketLengthImage,frontChestWidthImage,
            backWidthImage,halfShoulderWidthLeftImage,halfShoulderWidthRightImage,fullBackLengthImage,halfBackLengthImage,rightFullSleeveImage,leftFullSleeveImage;
    ImageButton rightSleeveZoomIcon,leftSleeveZoomIcon,bicepZoomIcon,wristZoomIcon,waistStomachZoomIcon,hipZoomIcon,frontJacketLengthZoomIcon,frontChestWidthZoomIcon,
            backWidthZoomIcon,halfShoulderWidthLeftZoomIcon,halfShoulderWidthRightZoomIcon,fullBackLengthZoomIcon,halfBackLengthZoomIcon,rightFullSleeveZoomIcon,leftFullSleeveZoomIcon;
    Button nextBtnM;
    Button rightSleeveSignBtn,leftSleeveSignBtn,bicepSignBtn,wristSignBtn,waistStomachSignBtn,hipSignBtn,frontJacketLengthSignBtn,frontChestWidthSignBtn,
            backWidthSignBtn,halfShoulderWidthLeftSignBtn,halfShoulderWidthRightSignBtn,fullBackLengthSignBtn,halfBackLengthSignBtn,rightFullSleeveSignBtn,leftFullSleeveSignBtn;
    String  measurementId,stanceId,shoulderSlopeId,chestDescriptionId,stomachDescriptionId,hipDescriptionId,stanceValue,stanceImgValue,
            ...
            stomachDescriptionValue,stomachDescriptionImgValue,hipDescriptionValue,hipDescriptionImgValue,rightSleeveValue,leftSleeveValue,bicepValue,wristValue,waistStomachValue,hipValue, frontJacketLengthValue,
            ...
            rightFullSleeveValue,leftFullSleeveValue;


    TextView fabricNumberData,liningNumberData;
    List<GridListItem> jacketStyleList,lapelStyleList,ventStyleList,breastPocketList,sidePocketList,ticketPocketList,cuffButtonStyleList,lapelCurvatureList,buttonsList,
            lapelEyeletColorList,cuffEyeletColorList,pipingColorList,meltonUndercollarNumberList,jacketFitList,functionalCuffsList,frontPanelRoundnessList,
            jacketLengthList,lapelPickStitchList,shoulderConstructionList,lapelSizeList;
    GridViewScrollable jacketStyle,lapelStyle,ventStyle,breastPocket,sidePocket,ticketPocket,cuffButtonStyle,lapelCurvature,buttons,
            lapelEyeletColor,cuffEyeletColor,pipingColor,meltonUndercollarNumber,jacketFit,functionalCuffs,frontPanelRoundness,
    ...
    StylingAdapter jacketStyleAdapter,lapelStyleAdapter,ventStyleAdapter,breastPocketAdapter,sidePocketAdapter,ticketPocketAdapter,
            cuffButtonStyleAdapter,lapelCurvatureAdapter,buttonsAdapter,lapelEyeletColorAdapter,
            cuffEyeletColorAdapter,pipingColorAdapter,meltonUndercollarNumberAdapter,jacketFitAdapter,functionalCuffsAdapter,frontPanelRoundnessAdapter,
            jacketLengthAdapter,lapelPickStitchAdapter,shoulderConstructionAdapter,lapelSizeAdapter;
    Drawable selected,unselected;
    Button nextBtnS;
    String  stylingId,jacketStyleId,lapelStyleId,ventStyleId,breastPocketId,sidePocketId,ticketPocketId,cuffButtonStyleId,lapelCurvatureId,
            buttonsId,lapelEyeletColorId,cuffEyeletColorId,pipingColorId,meltonUndercollarNumberId,jacketFitId,functionalCuffsId,
            ...
            breastPocketValue,sidePocketValue,ticketPocketValue,cuffButtonStyleValue,lapelCurvatureValue,buttonsValue,lapelEyeletColorValue,
            cuffEyeletColorValue,pipingColorValue,meltonUndercollarNumberValue,jacketFitValue,functionalCuffsValue,
            ...
            ventStyleImgValue,breastPocketImgValue,sidePocketImgValue,ticketPocketImgValue,cuffButtonStyleImgValue,lapelCurvatureImgValue,buttonsImgValue,lapelEyeletColorImgValue,cuffEyeletColorImgValue,pipingColorImgValue,
            meltonUndercollarNumberImgValue,jacketFitImgValue,functionalCuffsImgValue,frontPanelRoundnessImgValue,
            jacketLengthImgValue,lapelPickStitchImgValue,shoulderConstructionImgValue,lapelSizeImgValue;
    int     jacketStylePrice,lapelStylePrice,ventStylePrice,breastPocketPrice,sidePocketPrice,ticketPocketPrice,cuffButtonStylePrice,lapelCurvaturePrice,buttonsPrice,
            lapelEyeletColorPrice,cuffEyeletColorPrice,pipingColorPrice,meltonUndercollarNumberPrice,jacketFitPrice,functionalCuffsPrice,frontPanelRoundnessPrice,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_order_taking_jacket);
        setupUI(findViewById(R.id.content_order_taking_jacket));
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(OrderTakingJacket.this);
        ...
        container = (RelativeLayout) findViewById(R.id.content_order_taking_jacket);
        ...
        dateBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(OrderTakingJacket.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        Call<List<FabricLiningItem>> fabricData = service.ProcessFabricItem("jacket");
                ...
                fabricStyle.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        if(orderTypeValue.equals("Bespoke") && !fabricChoices.get(Integer.parseInt(fabricChoice.getSelectedItem().toString())).equals("Self")){
                            fabricPrice = Integer.parseInt(fabricListSearchable.get(position).getItemBsJacketPrice());
                        }
                        else if(orderTypeValue.equals("MTM") && !fabricChoices.get(Integer.parseInt(fabricChoice.getSelectedItem().toString())).equals("Self")) {
                            fabricPrice = Integer.parseInt(fabricListSearchable.get(position).getItemMtmJacketPrice());
                        }
        ...
        Call<List<LiningItem>> liningData = service.ProcessLiningItem("jacket");
            ...
            public void onResponse(Response<List<LiningItem>> response, Retrofit retrofit) {
                ...
                liningNumber.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        liningPrice = Integer.parseInt(liningListSearchable.get(position).getItemJacketPrice());
                        ...
                        if (response.body() != null) {
                            ...
                            if(fabricIdValue.equals("0")){
                                ...
                                if(orderTypeValue.equals("Bespoke")){
                                    fabricPrice = Integer.parseInt(fabricList.get(getFabricLiningIndex(fabricList,fabricIdValue)).getItemBsJacketPrice());
                                }
                                else if(orderTypeValue.equals("MTM")) {
                                    fabricPrice = Integer.parseInt(fabricList.get(getFabricLiningIndex(fabricList,fabricIdValue)).getItemMtmJacketPrice());
                                }
                            ...
                            liningPrice = Integer.parseInt(liningList.get(getLiningIndex(liningList,liningIdValue)).getItemJacketPrice());
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if(orderCondition.equals("New Customer")){
                            ...
                            if(!nameValue.equals("") && !contactPrimaryValue.equals("") && !emailValue.equals("") && !addressValue.equals("") && !billValue.equals("") && !expectedDateValue.equals("") && uniquePhoneNumber && validPhoneNumber && validSecondaryPhone && uniqueEmail){
                                ...
                                if(!fabricNumberValue.equals("") && !liningNumberValue.equals("") && jacketStyleValue != null && lapelStyleValue != null && ventStyleValue != null && breastPocketValue != null && sidePocketValue != null && ticketPocketValue != null && cuffButtonStyleValue != null&& lapelCurvatureValue != null && buttonsValue != null && lapelEyeletColorValue != null && cuffEyeletColorValue != null && pipingColorValue != null && meltonUndercollarNumberValue != null && jacketFitValue != null && functionalCuffsValue != null && frontPanelRoundnessValue != null && jacketLengthValue != null && lapelPickStitchValue != null && shoulderConstructionValue != null && lapelSizeValue != null && jacketStyleImgValue != null && lapelStyleImgValue != null && ventStyleImgValue != null && breastPocketImgValue != null && sidePocketImgValue != null && ticketPocketImgValue != null && cuffButtonStyleImgValue != null && lapelCurvatureImgValue != null && buttonsImgValue != null && lapelEyeletColorImgValue != null && cuffEyeletColorImgValue != null && pipingColorImgValue != null && meltonUndercollarNumberImgValue != null && jacketFitImgValue != null && functionalCuffsImgValue != null && frontPanelRoundnessImgValue != null && jacketLengthImgValue != null && lapelPickStitchImgValue != null && shoulderConstructionImgValue != null && lapelSizeImgValue != null){

                                    if(orderTypeValue.equals("Bespoke")) {
                                        if (stanceValue != null && stanceImgValue != null && shoulderSlopeValue != null && shoulderSlopeImgValue != null && chestDescriptionValue != null && chestDescriptionImgValue != null && stomachDescriptionValue != null && stomachDescriptionImgValue != null && hipDescriptionValue != null && hipDescriptionImgValue != null && !rightSleeveValue.equals("") && !leftSleeveValue.equals("") && !bicepValue.equals("") && !wristValue.equals("") && !waistStomachValue.equals("") && !hipValue.equals("") && !frontJacketLengthValue.equals("") && !frontChestWidthValue.equals("") && !backWidthValue.equals("") && !halfShoulderWidthLeftValue.equals("") && !halfShoulderWidthRightValue.equals("") && !fullBackLengthValue.equals("") && !halfBackLengthValue.equals("") && !rightFullSleeveValue.equals("") && !leftFullSleeveValue.equals("")) {
                                                                                    ...
                                                                                    public void onResponse(Response<String> response, Retrofit retrofit) {
                                                                                        ...
                                                                                        if(response.body().equals("Order Inserted")){
                                                                                            ...
                                                                                            Call<String> measurementData = service.InsertMeasurement(orderId,customerId,stanceId,stanceValue,stanceImgValue,shoulderSlopeId,
                                                                                                    ...
                                                                                                    stomachDescriptionValue,stomachDescriptionImgValue,hipDescriptionId,hipDescriptionValue,hipDescriptionImgValue,"","",
                                                                                                    "",rightSleeveValue,leftSleeveValue,bicepValue,wristValue,waistStomachValue,hipValue,frontJacketLengthValue,
                                                                                                    frontChestWidthValue,backWidthValue,halfShoulderWidthLeftValue,halfShoulderWidthRightValue,fullBackLengthValue,halfBackLengthValue,
                                                                                                    "","","","","","",rightFullSleeveValue,leftFullSleeveValue);
                                                                                            ...
                                                                                            measurementData.enqueue(new Callback<String>() {
                                                                                                ...
                                                                                                public void onResponse(Response<String> response, Retrofit retrofit) {
                                                                                                    ...
                                                                                                    Call<String> stylingData = service.InsertStyling(orderId,customerId,fabricIdValue,fabricNumberValue,liningIdValue,liningNumberValue,"","","",
                                                                                                            ...
                                                                                                            functionalCuffsValue,functionalCuffsImgValue,"","","","","", "","","","","","","", "","","","","","","", "","",buttonsId,buttonsValue,buttonsImgValue,lapelEyeletColorId,lapelEyeletColorValue,
                                                                                    ...
                                                                                    public void onResponse(Response<String> response, Retrofit retrofit) {
                                                                                        ...
                                                                                        if(response.body().equals("Order Inserted")){
                                                                                            ...
                                                                                            Call<String> measurementData = service.InsertMeasurement(orderId,customerId,stanceId,stanceValue,stanceImgValue,shoulderSlopeId,
                                                                                                    shoulderSlopeValue,shoulderSlopeImgValue,chestDescriptionId,chestDescriptionValue,chestDescriptionImgValue,stomachDescriptionId,
                                                                                                    stomachDescriptionValue,stomachDescriptionImgValue,hipDescriptionId,hipDescriptionValue,hipDescriptionImgValue,"","",
                                                                                                    "",rightSleeveSignBtn.getText().toString() + rightSleeveValue,leftSleeveSignBtn.getText().toString() + leftSleeveValue,bicepSignBtn.getText().toString() + bicepValue,wristSignBtn.getText().toString() + wristValue,waistStomachSignBtn.getText().toString() + waistStomachValue,hipSignBtn.getText().toString() + hipValue,frontJacketLengthSignBtn.getText().toString() + frontJacketLengthValue,
                                                                                                    ...
                                                                                                    "","","","","","",rightFullSleeveSignBtn.getText().toString() + rightFullSleeveValue,leftFullSleeveSignBtn.getText().toString() + leftFullSleeveValue);
        ...
        if (!(view instanceof EditText)) {
            view.setOnTouchListener(new View.OnTouchListener() {
                public boolean onTouch(View v, MotionEvent event) {
                    hideSoftKeyboard(OrderTakingJacket.this);
                    return false;
                }
            });
        }
    ...
    public void calculateAmount(){
        int totalAmount = fabricPrice + liningPrice + jacketStylePrice + lapelStylePrice + ventStylePrice + breastPocketPrice + sidePocketPrice + ticketPocketPrice + cuffButtonStylePrice + lapelCurvaturePrice + buttonsPrice +
                lapelEyeletColorPrice + cuffEyeletColorPrice + pipingColorPrice + meltonUndercollarNumberPrice + jacketFitPrice + functionalCuffsPrice + frontPanelRoundnessPrice +
                jacketLengthPrice + lapelPickStitchPrice + shoulderConstructionPrice + lapelSizePrice;
