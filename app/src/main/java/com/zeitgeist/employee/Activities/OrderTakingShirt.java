...
public class OrderTakingShirt extends AppCompatActivity {

    String orderCondition;

    IpClass ipClass = new IpClass();

    String shopId,itemType,orderId,fabricConnsumption,garmentId = "6";
    TextView title;
    ...
    EditText neck,fullChest,fullShoulderWidth,rightSleeve,leftSleeve,bicep,wrist,waistStomach,hip,frontChestWidth,
            backWidth,halfShoulderWidthLeft,halfShoulderWidthRight,fullBackLength,halfBackLength,rightFullSleeve,leftFullSleeve;
    ImageView neckImage,fullChestImage,fullShoulderWidthImage,rightSleeveImage,leftSleeveImage,bicepImage,wristImage,waistStomachImage,hipImage,frontChestWidthImage,
    ...
    ImageButton neckZoomIcon,fullChestZoomIcon,fullShoulderWidthZoomIcon,rightSleeveZoomIcon,leftSleeveZoomIcon,bicepZoomIcon,wristZoomIcon,waistStomachZoomIcon,hipZoomIcon,frontChestWidthZoomIcon,
    ...
    Button nextBtnM;
    Button neckSignBtn,fullChestSignBtn,fullShoulderWidthSignBtn,rightSleeveSignBtn,leftSleeveSignBtn,bicepSignBtn,wristSignBtn,waistStomachSignBtn,hipSignBtn,frontChestWidthSignBtn,
    ...
    String  measurementId,stanceId,hipDescriptionId,stanceValue,stanceImgValue,hipDescriptionValue,hipDescriptionImgValue,neckValue,fullChestValue,
            fullShoulderWidthValue,rightSleeveValue,leftSleeveValue,bicepValue,wristValue,waistStomachValue,hipValue,
            frontChestWidthValue,backWidthValue,halfShoulderWidthLeftValue,halfShoulderWidthRightValue,fullBackLengthValue,halfBackLengthValue,rightFullSleeveValue,leftFullSleeveValue;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_order_taking_shirt);
        setupUI(findViewById(R.id.content_order_taking_shirt));
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(OrderTakingShirt.this);
        ...
        container = (RelativeLayout) findViewById(R.id.content_order_taking_shirt);
        ...
        dateBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(OrderTakingShirt.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        Call<List<FabricLiningItem>> fabricData = service.ProcessFabricItem("shirt");
                ...
                fabricStyle.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        if(orderTypeValue.equals("Bespoke") && !fabricChoices.get(Integer.parseInt(fabricChoice.getSelectedItem().toString())).equals("Self")){
                            fabricPrice = Integer.parseInt(fabricListSearchable.get(position).getItemBsShirtPrice());
                        }
                        else if(orderTypeValue.equals("MTM") && !fabricChoices.get(Integer.parseInt(fabricChoice.getSelectedItem().toString())).equals("Self")) {
                            fabricPrice = Integer.parseInt(fabricListSearchable.get(position).getItemMtmShirtPrice());
                        }
                        ...
                        if (response.body() != null) {
                            ...
                            if(fabricIdValue.equals("0")){
                                ...
                                if(orderTypeValue.equals("Bespoke")){
                                    fabricPrice = Integer.parseInt(fabricList.get(getFabricLiningIndex(fabricList,fabricIdValue)).getItemBsShirtPrice());
                                }
                                else if(orderTypeValue.equals("MTM")) {
                                    fabricPrice = Integer.parseInt(fabricList.get(getFabricLiningIndex(fabricList,fabricIdValue)).getItemMtmShirtPrice());
                                }
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if(orderCondition.equals("New Customer")){
                            ...
                            if(!nameValue.equals("") && !contactPrimaryValue.equals("") && !emailValue.equals("") && !addressValue.equals("") && !billValue.equals("") && !expectedDateValue.equals("") && uniquePhoneNumber && validPhoneNumber && validSecondaryPhone && uniqueEmail){
                                ...
                                if(!fabricNumberValue.equals("")){

                                    if(orderTypeValue.equals("Bespoke")) {
                                        if (stanceValue != null && stanceImgValue != null && hipDescriptionValue != null && hipDescriptionImgValue != null && !neckValue.equals("") && !fullChestValue.equals("") && !fullShoulderWidthValue.equals("") && !rightSleeveValue.equals("") && !leftSleeveValue.equals("") && !bicepValue.equals("") && !wristValue.equals("") && !waistStomachValue.equals("") && !hipValue.equals("") && !frontChestWidthValue.equals("") && !backWidthValue.equals("") && !halfShoulderWidthLeftValue.equals("") && !halfShoulderWidthRightValue.equals("") && !fullBackLengthValue.equals("") && !halfBackLengthValue.equals("") && !rightFullSleeveValue.equals("") && !leftFullSleeveValue.equals("")) {
                                                                        ...
                                                                        public void onResponse(Response<String> response, Retrofit retrofit) {
                                                                            ...
                                                                            if(response.body().equals("Order Inserted")){
                                                                                ...
                                                                                Call<String> measurementData = service.InsertMeasurement(orderId,customerId,stanceId,stanceValue,stanceImgValue,"",
                                                                                        "","","","","","",
                                                                                        "","",hipDescriptionId,hipDescriptionValue,hipDescriptionImgValue,neckValue,fullChestValue,
                                                                                        fullShoulderWidthValue,rightSleeveValue,leftSleeveValue,bicepValue,wristValue,waistStomachValue,hipValue,"",
                                                                                ...
                                                                                measurementData.enqueue(new Callback<String>() {
                                                                                    ...
                                                                                    public void onResponse(Response<String> response, Retrofit retrofit) {
                                                                                        ...
                                                                                        Call<String> stylingData = service.InsertStyling(orderId,customerId,fabricIdValue,fabricNumberValue,"","","","","",
                                                                                                "","","","","","",
                                                                                                "","","","","","","","","",
                                                                                                "","","","","","",
                                                                                                "","","","","","","","","",
                                                                    ...
                                                                    orderData.enqueue(new Callback<String>() {
                                                                        ...
                                                                        public void onResponse(Response<String> response, Retrofit retrofit) {
                                                                            ...
                                                                            if(response.body().equals("Order Inserted")){
                                                                                ...
                                                                                Call<String> measurementData = service.InsertMeasurement(orderId,customerId,stanceId,stanceValue,stanceImgValue,"",
                                                                                        "","","","","","",
                                                                                        "","",hipDescriptionId,hipDescriptionValue,hipDescriptionImgValue,neckSignBtn.getText().toString() + neckValue,fullChestSignBtn.getText().toString() + fullChestValue,
                                                                                        fullShoulderWidthSignBtn.getText().toString() + fullShoulderWidthValue,rightSleeveSignBtn.getText().toString() + rightSleeveValue,leftSleeveSignBtn.getText().toString() + leftSleeveValue,bicepSignBtn.getText().toString() + bicepValue,wristSignBtn.getText().toString() + wristValue,waistStomachSignBtn.getText().toString() + waistStomachValue,hipSignBtn.getText().toString() + hipValue,"",
                                                                                    ...
                                                                                    updateMeasurementData.enqueue(new Callback<String>() {
                                                                                        ...
                                                                                        public void onResponse(Response<String> response, Retrofit retrofit) {
                                                                                            ...
                                                                                            if(response.body().equals("Successful")){
                                                                                                ...
                                                                                                Call<String> updateStylingData = service.UpdateStyling(stylingId,fabricIdValue,fabricNumberValue,"","","","","",
                                                                                                        "","","","","","",
                                                                                                        "","","","","","","","","",
                                                                                                        "","","","","","",
                                                                                                        "","","","","","","","","",
        ...
        if (!(view instanceof EditText)) {
            view.setOnTouchListener(new View.OnTouchListener() {
                public boolean onTouch(View v, MotionEvent event) {
                    hideSoftKeyboard(OrderTakingShirt.this);
                    return false;
                }
            });
        }
